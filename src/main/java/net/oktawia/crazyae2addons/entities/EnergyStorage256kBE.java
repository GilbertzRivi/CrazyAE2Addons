...
public class EnergyStorage256kBE extends EnergyCellBlockEntity {

    private final StoredEnergyAmount stored;

    public EnergyStorage256kBE(BlockPos pos, BlockState blockState) {
        super(CrazyBlockEntityRegistrar.ENERGY_STORAGE_256K.get(), pos, blockState);
        this.getMainNode()
                .setIdlePowerUsage(0)
                .addService(IAEPowerStorage.class, this)
                .addService(IGridTickable.class, this);

        this.stored = new StoredEnergyAmount(0, EnergyStorage256k.getMaxEnergy(), this::emitPowerEvent);
    }
