...
navigation:
  ...
  icon: crazyae2addonslite:wormhole_tunnel
categories:
  - Energy and Item Transfer
item_ids:
  - crazyae2addonslite:wormhole_tunnel
---
...
Unlike regular P2P tunnels, Wormhole tunnels can form **bidirectional connections**, and **combine capabilities** when interacting with multiple outputs.
