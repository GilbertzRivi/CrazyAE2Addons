...
public class PenroseControllerScreen<C extends PenroseControllerMenu> extends AEBaseScreen<C> {
    ...
    public PenroseControllerScreen(C menu, Inventory playerInventory, Component title, ScreenStyle style) {
        ...
        this.bhWidget.setMassLimits(menu.initialBhMass, menu.maxBhMass);
    ...
    public void updateBeforeRender() {
        ...
        bhWidget.setMassLimits(getMenu().initialBhMass, getMenu().maxBhMass);
        ...
        setTextContent("generation",
                Component.translatable("gui.crazyae2addons.penrose_bh_status", activeText)
                        .append(Component.literal(" | Gen: " + gen + " FE/t | Use: " + con + " FE/t")));
    }
}
