...
import net.oktawia.crazyae2addons.screens.EmitterTerminalScreen;
import net.oktawia.crazyae2addons.screens.WirelessEmitterTerminalScreen;
...
public record EmitterWindowPacket(
    ...
    public static void handle(EmitterWindowPacket pkt, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            } else if (screen instanceof WirelessEmitterTerminalScreen<?> s) {
                s.applyEmitterWindow(pkt);
            }
        });
