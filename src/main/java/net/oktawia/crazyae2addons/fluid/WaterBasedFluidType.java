...
public class WaterBasedFluidType extends FluidType {
    ...
    private static final ResourceLocation WATER_STILL = new ResourceLocation(CrazyAddons.MODID, "block/water_still");
    private static final ResourceLocation WATER_FLOW = new ResourceLocation(CrazyAddons.MODID, "block/water_flowing");
    private static final ResourceLocation WATER_OVERLAY = new ResourceLocation(CrazyAddons.MODID, "block/water_overlay");
