package net.oktawia.crazyae2addonslite.implementations;
...
public class StackTransferContextImplementation implements StackTransferContext {
    ...
    public StackTransferContextImplementation(IStorageService internalStorage, IEnergySource energySource,
