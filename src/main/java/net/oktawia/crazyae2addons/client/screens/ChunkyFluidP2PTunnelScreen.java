...
public class ChunkyFluidP2PTunnelScreen<C extends ChunkyFluidP2PTunnelMenu> extends AEBaseScreen<C> {
    ...
    private void setupGui() {
        this.setTextContent("info1", Component.translatable("gui.crazyae2addons.unit_size"));
        ...
        confirm = new PlainTextButton(
                0, 0, 0, 0, Component.translatable("gui.crazyae2addons.confirm"), btn -> save(), Minecraft.getInstance().font);
    }
