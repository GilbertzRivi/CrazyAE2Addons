...
public enum LangDefs implements LocalizationEnum {
    ...
    ACTIVE("gui.crazyae2addons.active", "Active"),
    INACTIVE("gui.crazyae2addons.inactive", "Inactive"),
    STATUS("gui.crazyae2addons.status", "Status: %s"),
    HEAT("gui.crazyae2addons.heat", "Heat"),
    EFFICIENCY("gui.crazyae2addons.efficiency", "Efficiency: %s"),
    GEN_FE_PER_TICK("gui.crazyae2addons.gen_fe_per_tick", "Gen: %s FE/t"),
    USE_FE_PER_TICK("gui.crazyae2addons.use_fe_per_tick", "Use: %s FE/t"),
    OVERVIEW("gui.crazyae2addons.overview", "Overview"),
    STORED_FE("gui.crazyae2addons.stored_fe", "Stored: %s FE"),
    ...
    PENROSE_BH_MASS_HEAT("gui.crazyae2addons.penrose_bh_mass_heat", "Mass: %s × M₀ | %s"),
    PENROSE_BH_MASS_DELTA("gui.crazyae2addons.penrose_bh_mass_delta", "Mass Δ: %s/s (%s)"),
    PENROSE_TITLE_ACCRETION_DISK("gui.crazyae2addons.penrose_title_accretion_disk", "Accretion Disk"),
    PENROSE_DISK_MASS("gui.crazyae2addons.penrose_disk_mass", "Disk mass: %s singu"),
    PENROSE_FE_IN_DISK("gui.crazyae2addons.penrose_fe_in_disk", "FE in disk: %s"),
    PENROSE_HEAT_GK("gui.crazyae2addons.penrose_heat_gk", "Heat: %s GK"),
    PENROSE_TITLE_MASS("gui.crazyae2addons.penrose_title_mass", "Black Hole Mass"),
    ...
    PENROSE_HEAT_MAX_GK("gui.crazyae2addons.penrose_heat_max_gk", "Max: %s GK"),
    PENROSE_HEAT_BAR("gui.crazyae2addons.penrose_heat_bar", "%s / %s GK"),
    PENROSE_OVERLAY_BH_MASS("gui.crazyae2addons.penrose_overlay_bh_mass", "BH: %s MU"),
    PENROSE_OVERLAY_DISK_MASS("gui.crazyae2addons.penrose_overlay_disk_mass", "Disk: %s"),
    PENROSE_OVERLAY_FE_STORED("gui.crazyae2addons.penrose_overlay_fe_stored", "FE: %s"),
    PENROSE_OVERLAY_FE_IN_DISK("gui.crazyae2addons.penrose_overlay_fe_in_disk", "Disk FE: %s"),
    SUBMIT("gui.crazyae2addons.submit", "Apply"),
    COST_PER_TICK("gui.crazyae2addons.cost_per_tick", "FE cost: %s/t"),
    TOGGLE_PREVIEW("gui.crazyae2addons.toggle_preview", "Toggle preview"),
    PENROSE_HEAT_VENT_COOLING_LABEL("gui.crazyae2addons.penrose_heat_vent_cooling_label", "Cooling (GK/t):"),
    PENROSE_HEAT_VENT_COST_LABEL("gui.crazyae2addons.penrose_heat_vent_cost_label", "Energy cost:"),
    PENROSE_HEAT_VENT_COOLING_HINT("gui.crazyae2addons.penrose_heat_vent_cooling_hint", "GK/t"),
    PENROSE_HEAT_VENT_COOLING_TOOLTIP("gui.crazyae2addons.penrose_heat_vent_cooling_tooltip", "Amount of heat removed per tick (GK/t)"),
    PENROSE_HAWKING_VENT_RATE_LABEL("gui.crazyae2addons.penrose_hawking_vent_rate_label", "Evaporation (MU/t):"),
    PENROSE_HAWKING_VENT_COST_LABEL("gui.crazyae2addons.penrose_hawking_vent_cost_label", "Energy cost:"),
    PENROSE_HAWKING_VENT_EVAP_HINT("gui.crazyae2addons.penrose_hawking_vent_evap_hint", "MU/t"),
    PENROSE_HAWKING_VENT_EVAP_TOOLTIP("gui.crazyae2addons.penrose_hawking_vent_evap_tooltip", "Amount of black hole mass evaporated per tick (MU/t)"),
    PENROSE_INJECTION_PORT_RATE_LABEL("gui.crazyae2addons.penrose_injection_port_rate_label", "Injection rate:"),
    PENROSE_INJECTION_PORT_RATE_HINT("gui.crazyae2addons.penrose_injection_port_rate_hint", "singu/t"),
    PENROSE_INJECTION_PORT_RATE_TOOLTIP("gui.crazyae2addons.penrose_injection_port_rate_tooltip", "Singularities injected per tick when powered"),
    PENROSE_HEAT_EMITTER_ON_LABEL("gui.crazyae2addons.penrose_heat_emitter_on_label", "Activate above (GK):"),
    PENROSE_HEAT_EMITTER_OFF_LABEL("gui.crazyae2addons.penrose_heat_emitter_off_label", "Deactivate below (GK):"),
    PENROSE_HEAT_EMITTER_ON_TOOLTIP("gui.crazyae2addons.penrose_heat_emitter_on_tooltip", "Turn on above this heat (GK)"),
    PENROSE_HEAT_EMITTER_OFF_TOOLTIP("gui.crazyae2addons.penrose_heat_emitter_off_tooltip", "Turn off below this heat (GK)"),
    PENROSE_HEAT_EMITTER_ON_PLACEHOLDER("gui.crazyae2addons.penrose_heat_emitter_on_placeholder", "ON (GK)"),
    PENROSE_HEAT_EMITTER_OFF_PLACEHOLDER("gui.crazyae2addons.penrose_heat_emitter_off_placeholder", "OFF (GK)"),
    PENROSE_MASS_EMITTER_ON_LABEL("gui.crazyae2addons.penrose_mass_emitter_on_label", "Activate above (%):"),
    PENROSE_MASS_EMITTER_OFF_LABEL("gui.crazyae2addons.penrose_mass_emitter_off_label", "Deactivate below (%):"),
    PENROSE_MASS_EMITTER_ON_TOOLTIP("gui.crazyae2addons.penrose_mass_emitter_on_tooltip", "Turn on above this mass (%)"),
    PENROSE_MASS_EMITTER_OFF_TOOLTIP("gui.crazyae2addons.penrose_mass_emitter_off_tooltip", "Turn off below this mass (%)"),
    PENROSE_MASS_EMITTER_ON_PLACEHOLDER("gui.crazyae2addons.penrose_mass_emitter_on_placeholder", "ON (%)"),
    PENROSE_MASS_EMITTER_OFF_PLACEHOLDER("gui.crazyae2addons.penrose_mass_emitter_off_placeholder", "OFF (%)");
