...
public class IntGreaterThanNode implements IFlowNode {

    private IFlowNode onTrue;
    private IFlowNode onFalse;

    public IntGreaterThanNode() {
    }
    ...
    public String getDesc() {
        return "Compares INT marked with \"^A\" against one marked with \"^B\", true if A is bigger";
    }
