...
public final class Screens {
    ...
    public static void register(RegisterMenuScreensEvent event) {
        ...
        InitScreens.register(event, CrazyMenuRegistrar.ENTITY_TICKER_MENU.get(),
                EntityTickerScreen<EntityTickerMenu>::new,
                "/screens/entity_ticker.json");

        InitScreens.register(event, CrazyMenuRegistrar.NBT_EXPORT_BUS_MENU.get(),
                NBTExportBusScreen<NBTExportBusMenu>::new,
                "/screens/nbt_export_bus.json");

        InitScreens.register(event, CrazyMenuRegistrar.NBT_STORAGE_BUS_MENU.get(),
                NBTStorageBusScreen<NBTStorageBusMenu>::new,
                "/screens/nbt_storage_bus.json");

        InitScreens.register(event, CrazyMenuRegistrar.CRAZY_PATTERN_MODIFIER_MENU.get(),
        ...
        InitScreens.register(event, CrazyMenuRegistrar.ME_DATA_CONTROLLER_MENU.get(),
                MEDataControllerScreen<MEDataControllerMenu>::new,
                "/screens/me_data_controller.json");

        InitScreens.register(event, CrazyMenuRegistrar.DATA_EXTRACTOR_MENU.get(),
        ...
        InitScreens.register(event, CrazyMenuRegistrar.ENERGY_EXPORTER_MENU.get(),
        ...
        InitScreens.register(event, CrazyMenuRegistrar.CRAZY_PATTERN_MULTIPLIER_MENU.get(),
                CrazyPatternMultiplierScreen<CrazyPatternMultiplierMenu>::new,
                "/screens/crazy_pattern_multiplier.json");

        InitScreens.register(event, CrazyMenuRegistrar.IMPULSED_PATTERN_PROVIDER_MENU.get(),
                ImpulsedPatternProviderScreen<ImpulsedPatternProviderMenu>::new,
                "/screens/impulsed_pattern_provider.json");

        InitScreens.register(event, CrazyMenuRegistrar.SIGNALLING_INTERFACE_MENU.get(),
                SignallingInterfaceScreen<SignallingInterfaceMenu>::new,
                "/screens/signalling_interface.json");

        InitScreens.register(event, CrazyMenuRegistrar.SET_STOCK_AMOUNT_MENU.get(),
                SetStockAmountScreen<SetStockAmountMenu>::new,
                "/screens/set_stock_amount.json");

        InitScreens.register(event, CrazyMenuRegistrar.MOB_EXPORT_BUS_MENU.get(),
        ...
        InitScreens.register(event, CrazyMenuRegistrar.CRAZY_EMITTER_MULTIPLIER_MENU.get(),
                CrazyEmitterMultiplierScreen<CrazyEmitterMultiplierMenu>::new,
                "/screens/crazy_emitter_multiplier.json");

        InitScreens.register(event, CrazyMenuRegistrar.CRAZY_CALCULATOR_MENU.get(),
        ...
        InitScreens.register(event, CrazyMenuRegistrar.MOB_FORMATION_PLANE_MENU.get(),
                MobFormationPlaneScreen<MobFormationPlaneMenu>::new,
                "/screens/mob_formation_plane.json");

        InitScreens.register(event, CrazyMenuRegistrar.SPAWNER_EXTRACTOR_CONTROLLER_MENU.get(),
                SpawnerExtractorControllerScreen<SpawnerExtractorControllerMenu>::new,
                "/screens/spawner_controller.json");

        InitScreens.register(event, CrazyMenuRegistrar.MOB_FARM_CONTROLLER_MENU.get(),
        ...
        InitScreens.register(event, CrazyMenuRegistrar.REDSTONE_EMITTER_MENU.get(),
                RedstoneEmitterScreen<RedstoneEmitterMenu>::new,
                "/screens/redstone_emitter.json");

        InitScreens.register(event, CrazyMenuRegistrar.REDSTONE_TERMINAL_MENU.get(),
                RedstoneTerminalScreen<RedstoneTerminalMenu>::new,
                "/screens/redstone_terminal.json");

        InitScreens.register(event, CrazyMenuRegistrar.WIRELESS_REDSTONE_TERMINAL_MENU.get(),
                WirelessRedstoneTerminalScreen<WirelessRedstoneTerminalMenu>::new,
                "/screens/wireless_redstone_terminal.json");

        InitScreens.register(event, CrazyMenuRegistrar.REINFORCED_MATTER_CONDENSER_MENU.get(),
        ...
        InitScreens.register(event, CrazyMenuRegistrar.ENERGY_STORAGE_CONTROLLER_MENU.get(),
                EnergyStorageControllerScreen<EnergyStorageControllerMenu>::new,
                "/screens/energy_storage_controller.json");

        InitScreens.register(event, CrazyMenuRegistrar.VARIABLE_TERMINAL_MENU.get(),
        ...
        InitScreens.register(event, CrazyMenuRegistrar.ENTROPY_CRADLE_CONTROLLER_MENU.get(),
                EntropyCradleControllerScreen<EntropyCradleControllerMenu>::new,
                "/screens/entropy_cradle_controller.json");

        InitScreens.register(event, CrazyMenuRegistrar.PLAYER_DATA_EXTRACTOR_MENU.get(),
                PlayerDataExtractorScreen<PlayerDataExtractorMenu>::new,
                "/screens/player_data_extractor.json");

        InitScreens.register(event, CrazyMenuRegistrar.DATAFLOW_PATTERN_MENU.get(),
                DataflowPatternScreen<DataflowPatternMenu>::new,
                "/screens/dataflow_pattern.json");

        InitScreens.register(event, CrazyMenuRegistrar.DATA_PROCESSOR_MENU.get(),
                DataProcessorScreen<DataProcessorMenu>::new,
                "/screens/data_processor.json");

        InitScreens.register(event, CrazyMenuRegistrar.CRAZY_PATTERN_MODIFIER_MENU_PP.get(),
                CrazyPatternModifierScreenPP<CrazyPatternModifierMenuPP>::new,
                "/screens/crazy_pattern_modifier_pp.json");

        InitScreens.register(event, CrazyMenuRegistrar.NBT_VIEW_CELL_MENU.get(),
                NbtViewCellScreen<NbtViewCellMenu>::new,
                "/screens/view_cell.json");

        InitScreens.register(event, CrazyMenuRegistrar.TAG_VIEW_CELL_MENU.get(),
                TagViewCellScreen<TagViewCellMenu>::new,
                "/screens/view_cell.json");

        InitScreens.register(event, CrazyMenuRegistrar.CPU_PRIO_MENU.get(),
                CpuPrioScreen<CpuPrioMenu>::new,
                "/screens/cpu_prio.json");

        InitScreens.register(event, CrazyMenuRegistrar.RESEARCH_STATION_MENU.get(),
                ResearchStationScreen<ResearchStationMenu>::new,
                "/screens/research_station.json");

        InitScreens.register(event, CrazyMenuRegistrar.GADGET_MENU.get(),
                GadgetScreen<GadgetMenu>::new,
                "/screens/gadget.json");

        InitScreens.register(event, CrazyMenuRegistrar.DATA_DRIVE_MENU.get(),
                DataDriveScreen<DataDriveMenu>::new,
                "/screens/data_drive.json");

        InitScreens.register(event, CrazyMenuRegistrar.RECIPE_FABRICATOR_MENU.get(),
                RecipeFabricatorScreen<RecipeFabricatorMenu>::new,
                "/screens/fabricator.json");

        InitScreens.register(event, CrazyMenuRegistrar.MOB_KEY_SELECTOR_MENU.get(),
