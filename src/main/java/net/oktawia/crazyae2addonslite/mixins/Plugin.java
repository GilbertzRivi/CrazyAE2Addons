...
public class Plugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        return switch (mixinClassName) {
            case "net.oktawia.crazyae2addonslite.mixins.AAEExecutingCraftingJobAccessor",
                 "net.oktawia.crazyae2addonslite.mixins.AAECraftingServiceMixin" -> isModLoaded("advanced_ae");
            case "net.oktawia.crazyae2addonslite.mixins.MixinCraftingService" -> !isModLoaded("advanced_ae");
            case "net.oktawia.crazyae2addonslite.mixins.MixinCraftingCpuLogicAE2" -> !hasTrySubmitJobBoolean;
            case "net.oktawia.crazyae2addonslite.mixins.MixinCraftingCpuLogicAE2CL" -> hasTrySubmitJobBoolean;
            default -> true;
        };
    }
