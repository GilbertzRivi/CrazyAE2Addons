...
public class EnergyStorage64kBE extends EnergyCellBlockEntity {

    private final StoredEnergyAmount stored;

    public EnergyStorage64kBE(BlockPos pos, BlockState blockState) {
        super(CrazyBlockEntityRegistrar.ENERGY_STORAGE_64K.get(), pos, blockState);
        this.getMainNode()
                .setIdlePowerUsage(0)
                .addService(IAEPowerStorage.class, this)
                .addService(IGridTickable.class, this);

        this.stored = new StoredEnergyAmount(0, EnergyStorage64k.getMaxEnergy(), this::emitPowerEvent);
    }
