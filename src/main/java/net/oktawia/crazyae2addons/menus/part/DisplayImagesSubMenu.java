...
public class DisplayImagesSubMenu extends AEBaseMenu implements ISubMenu {
    ...
    public DisplayImagesSubMenu(int id, Inventory inv, @Nullable DisplayPart host) {
    ...
    public void removeImage(String id) {
        if (isClientSide()) {
            ...
            if (id != null && id.equals(this.selectedImageId)) {
                this.selectedImageId = images.isEmpty() ? "" : images.getFirst().id();
            }
    ...
    private void sendSelectedPreviewToClient() {
        ...
        PacketDistributor.sendToPlayer(player, new SyncDisplayImagePreviewPacket(imageId, bytes));
    }
}