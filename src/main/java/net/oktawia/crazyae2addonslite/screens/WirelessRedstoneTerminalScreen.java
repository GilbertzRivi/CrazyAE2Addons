...
import net.oktawia.crazyae2addonslite.menus.RedstoneTerminalMenu;
...
import static net.oktawia.crazyae2addonslite.menus.WirelessRedstoneTerminalMenu.GSON;

public class WirelessRedstoneTerminalScreen<C extends WirelessRedstoneTerminalMenu>
    ...
    private @NotNull List<RedstoneTerminalMenu.EmitterInfo> getEmittersRaw() {
        return RedstoneTerminalMenu.GSON.fromJson(
                getMenu().emitters,
