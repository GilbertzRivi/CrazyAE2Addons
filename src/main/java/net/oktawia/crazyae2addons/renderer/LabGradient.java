...
public class LabGradient {
    ...
    public static float[] labGradient(float[] rgb1, float[] rgb2, double t) {
        double[] lab1 = xyzToLab(rgbToXyz(rgb1[0], rgb1[1], rgb1[2])[0], rgbToXyz(rgb1[0], rgb1[1], rgb1[2])[1], rgbToXyz(rgb1[0], rgb1[1], rgb1[2])[2]);

        double[] lab2 = xyzToLab(rgbToXyz(rgb2[0], rgb2[1], rgb2[2])[0], rgbToXyz(rgb2[0], rgb2[1], rgb2[2])[1], rgbToXyz(rgb2[0], rgb2[1], rgb2[2])[2]);
