...
public class BoolAndNode implements IFlowNode {
    ...
    static public String getDesc() {
        return "Compares two boolean values and gives true only if both are true, false otherwise";
    }

    static public int getOutputPaths() {
        return 2;
    }

    static public List<?> getInputTypes() {
        return List.of(Boolean.class, Boolean.class);
    }

    static public Map<String, DataType> getExpectedInputs() {
        return Map.of(
                "a", DataType.BOOL,
                "b", DataType.BOOL
        );
