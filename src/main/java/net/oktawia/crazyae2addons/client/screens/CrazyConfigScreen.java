...
public class CrazyConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        addSection(root, eb, LangDefs.CONFIG_SECTION_PORTABLE_SPATIAL_STORAGE, entries -> {
                    entries.add(bool(eb, LangDefs.CONFIG_ENTRY_ENABLED, cfg.PORTABLE_SPATIAL_STORAGE_ENABLED.get(), true,
                            cfg.PORTABLE_SPATIAL_STORAGE_ENABLED::set,
                            LangDefs.CONFIG_DESC_PSS_ENABLED
                    ));
                    entries.add(integer(eb, LangDefs.CONFIG_ENTRY_COST_PER_BLOCK, cfg.PORTABLE_SPATIAL_STORAGE_COST.get(), 1, 0,
                    ...
                    entries.add(integer(eb, LangDefs.CONFIG_ENTRY_BASE_INTERNAL_POWER_CAPACITY, cfg.PORTABLE_SPATIAL_STORAGE_BASE_INTERNAL_POWER_CAPACITY.get(), 200000, 0,
                            ...
                            LangDefs.CONFIG_DESC_PSS_BASE_POWER_2
                    ));
                    entries.add(integer(eb, LangDefs.CONFIG_ENTRY_MAX_STRUCTURE_SIZE_UNLIMITED, cfg.PORTABLE_SPATIAL_STORAGE_MAX_STRUCTURE_SIZE.get(), -1, -1,
                            cfg.PORTABLE_SPATIAL_STORAGE_MAX_STRUCTURE_SIZE::set,
                            LangDefs.CONFIG_DESC_PSS_MAX_STRUCTURE_SIZE,
                            LangDefs.CONFIG_DESC_UNLIMITED_MINUS_ONE
                    ));
                },
                LangDefs.CONFIG_SECTION_PORTABLE_SPATIAL_STORAGE_DESC_1,
                LangDefs.CONFIG_SECTION_PORTABLE_SPATIAL_STORAGE_DESC_2,
                LangDefs.CONFIG_SECTION_PORTABLE_SPATIAL_STORAGE_DESC_3
        );

        addSection(root, eb, LangDefs.CONFIG_SECTION_PORTABLE_SPATIAL_CLONER, entries -> {
                    entries.add(bool(eb, LangDefs.CONFIG_ENTRY_ENABLED, cfg.PORTABLE_SPATIAL_CLONER_ENABLED.get(), true,
                            cfg.PORTABLE_SPATIAL_CLONER_ENABLED::set,
                            LangDefs.CONFIG_DESC_PSC_ENABLED
                    ));
                    entries.add(integer(eb, LangDefs.CONFIG_ENTRY_COST_PER_BLOCK, cfg.PORTABLE_SPATIAL_CLONER_COST.get(), 1, 0,
                    ...
                    entries.add(integer(eb, LangDefs.CONFIG_ENTRY_BASE_INTERNAL_POWER_CAPACITY, cfg.PORTABLE_SPATIAL_CLONER_BASE_INTERNAL_POWER_CAPACITY.get(), 200000, 0,
                            ...
                            LangDefs.CONFIG_DESC_PSC_BASE_POWER_1,
                            LangDefs.CONFIG_DESC_PSC_BASE_POWER_2
                    ));
                    entries.add(integer(eb, LangDefs.CONFIG_ENTRY_MAX_STRUCTURE_SIZE_UNLIMITED, cfg.PORTABLE_SPATIAL_CLONER_MAX_STRUCTURE_SIZE.get(), -1, -1,
                            cfg.PORTABLE_SPATIAL_CLONER_MAX_STRUCTURE_SIZE::set,
                            LangDefs.CONFIG_DESC_PSC_MAX_STRUCTURE_SIZE,
                            LangDefs.CONFIG_DESC_UNLIMITED_MINUS_ONE
                    ));
                },
                LangDefs.CONFIG_SECTION_PORTABLE_SPATIAL_CLONER_DESC_1,
                LangDefs.CONFIG_SECTION_PORTABLE_SPATIAL_CLONER_DESC_2,
                LangDefs.CONFIG_SECTION_PORTABLE_SPATIAL_CLONER_DESC_3
        );
