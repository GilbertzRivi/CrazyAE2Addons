...
public class CopyGadgetMenu extends AEBaseMenu {
    ...
    public CopyGadgetMenu(int id, Inventory playerInventory, CopyGadgetHost host) {
        super(CrazyMenuRegistrar.COPY_GADGET_MENU.get(), id, playerInventory, host);
        IUpgradeInventory upgrades = UpgradeInventories.forItem(host.getItemStack(), 5);
