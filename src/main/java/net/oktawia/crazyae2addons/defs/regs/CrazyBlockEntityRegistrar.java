...
public class CrazyBlockEntityRegistrar {
    ...
    private static <T extends AEBaseBlockEntity> DeferredHolder<BlockEntityType<?>, BlockEntityType<T>> reg(
        ...
        return BLOCK_ENTITIES.register(id, () -> {
            ...
            // AE2 łączy blok z BE po registracji typu
            BLOCK_ENTITY_SETUP.add(() -> ((AEBaseEntityBlock<?>) blk).setBlockEntity(
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<MEDataControllerBE>> ME_DATA_CONTROLLER_BE =
            reg("me_data_controller_be", CrazyBlockRegistrar.ME_DATA_CONTROLLER_BLOCK, MEDataControllerBE::new, MEDataControllerBE.class);

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DataProcessorBE>> DATA_PROCESSOR_BE =
            reg("data_processor_be", CrazyBlockRegistrar.DATA_PROCESSOR_BLOCK, DataProcessorBE::new, DataProcessorBE.class);

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ImpulsedPatternProviderBE>> IMPULSED_PATTERN_PROVIDER_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SignallingInterfaceBE>> SIGNALLING_INTERFACE_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SpawnerExtractorControllerBE>> SPAWNER_EXTRACTOR_CONTROLLER_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SpawnerExtractorWallBE>> SPAWNER_EXTRACTOR_WALL_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<MobFarmControllerBE>> MOB_FARM_CONTROLLER_BE =
            reg("mob_farm_controller_be", CrazyBlockRegistrar.MOB_FARM_CONTROLLER, MobFarmControllerBE::new, MobFarmControllerBE.class);

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<MobFarmWallBE>> MOB_FARM_WALL_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ReinforcedMatterCondenserBE>> REINFORCED_MATTER_CONDENSER_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EnergyStorageControllerBE>> ENERGY_STORAGE_CONTROLLER_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EnergyStorageFrameBE>> ENERGY_STORAGE_FRAME_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EnergyStoragePortBE>> ENERGY_STORAGE_PORT_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EntropyCradleBE>> ENTROPY_CRADLE_BE =
            reg("entropy_cradle_be", CrazyBlockRegistrar.ENTROPY_CRADLE, EntropyCradleBE::new, EntropyCradleBE.class);

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EntropyCradleCapacitorBE>> ENTROPY_CRADLE_CAPACITOR_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<EntropyCradleControllerBE>> ENTROPY_CRADLE_CONTROLLER_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SuperSingularityBlockBE>> SUPER_SINGULARITY_BLOCK_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ResearchStationBE>> RESEARCH_STATION_BE =
            reg("research_station_be", CrazyBlockRegistrar.RESEARCH_STATION, ResearchStationBE::new, ResearchStationBE.class);

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<RecipeFabricatorBE>> RECIPE_FABRICATOR_BE =
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<? extends AutoEnchanterBE>> AUTO_ENCHANTER_BE =
            BLOCK_ENTITIES.register("auto_enchanter", () -> {
                ...
                if (IsModLoaded.isApothLoaded()) {
                    ...
                    BLOCK_ENTITY_SETUP.add(() -> ((AEBaseEntityBlock<?>) blk).setBlockEntity(AutoEnchanterBE.class, type, null, null));
                    return type;
                }
            });
