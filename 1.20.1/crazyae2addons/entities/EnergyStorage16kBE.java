...
public class EnergyStorage16kBE extends EnergyCellBlockEntity {

    private final StoredEnergyAmount stored;

    public EnergyStorage16kBE(BlockPos pos, BlockState blockState) {
        super(CrazyBlockEntityRegistrar.ENERGY_STORAGE_16K.get(), pos, blockState);
        this.getMainNode()
                .setIdlePowerUsage(0)
                .addService(IAEPowerStorage.class, this)
                .addService(IGridTickable.class, this);

        this.stored = new StoredEnergyAmount(0, EnergyStorage16k.getMaxEnergy(), this::emitPowerEvent);
    }
